  ...
  const validateField = (field, value) => {
    ...
    switch (field) {
      ...
      case "acepta_tratamiento_datos":
        if (!value) {
          errorMsg = "Debes aceptar el tratamiento de datos personales";
        }
        break;
      ...
      <div className="bg-white/90 rounded-3xl shadow-2xl overflow-hidden w-full max-w-4xl max-h-screen overflow-y-auto">
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Términos y Condiciones y Tratamiento de Datos */}
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div className="text-sm text-gray-600 space-y-3 max-h-32 overflow-y-auto">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Uso responsable de la plataforma médica</li>
                    <li>
                      Mantener la confidencialidad de la información médica
                    </li>
                    <li>No compartir credenciales de acceso</li>
                    <li>Cumplir con las normativas de protección de datos</li>
                    <li>Reportar cualquier uso indebido del sistema</li>
                    <li>Respetar los horarios de atención médica</li>
                    <li>Proporcionar información veraz y actualizada</li>
                  </ul>
                  <p className="text-xs text-gray-500 mt-3">
                    Al continuar, confirmas que has leído y aceptas estos
                    términos.
                  </p>
                </div>
                <div className="mt-4">
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
                ...
                <div className="text-sm text-gray-600 space-y-3 max-h-32 overflow-y-auto">
                  <p>
                    ...
                    2013, informamos sobre el tratamiento de sus datos
                    personales:
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                    ...
                    <li>
                      <strong>Finalidad:</strong> Gestión de citas médicas,
                      historiales clínicos y atención médica
                    </li>
                    <li>
                      <strong>Datos recopilados:</strong> Información personal,
                      médica y de contacto
                    </li>
                    <li>
                      <strong>Derechos:</strong> Conocer, actualizar, rectificar
                      y suprimir sus datos
                    </li>
                    <li>
                      <strong>Seguridad:</strong> Implementamos medidas técnicas
                      y administrativas de protección
                    </li>
                    <li>
                      <strong>Retención:</strong> Los datos se conservarán según
                      la normativa médica vigente
                    </li>
                  </ul>
                  <p className="text-xs text-gray-500 mt-3">
                    Para ejercer sus derechos, contacte: privacidad@medinet.com
                  </p>
                </div>
                <div className="mt-4">
                  <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  {errors.acepta_tratamiento_datos &&
                    touched.acepta_tratamiento_datos && (
                      <p className="text-red-500 text-sm mt-1 flex items-center">
                        <ExclamationCircleIcon className="h-4 w-4 mr-1" />
                        {errors.acepta_tratamiento_datos}
                      </p>
